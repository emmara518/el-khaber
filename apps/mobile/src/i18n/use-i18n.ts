...
const ARABIC: Record<string, string> = {
  ...
  'discovery.hero.headline': 'أنت في المكان الصحيح للعثور على الفني المناسب',
  'discovery.resultsCount': 'نتيجة',
  'discovery.filters': 'تصفية النتائج',
  'discovery.apply': 'تطبيق المرشحات',
  'discovery.clear': 'مسح المرشحات',
  'discovery.empty.title': 'لا يوجد فنيون متاحون حالياً',
  'discovery.empty.body': 'لم نعثر على فنيين يطابقون بحثك الحالي. جرّب توسيع البحث أو العودة لاحقاً — تُحدَّث القائمة باستمرار.',
  'discovery.empty.hintFilters': 'جرّب توسيع البحث أو مسح بعض المرشحات.',
  'discovery.empty.hintLater': 'يمكنك العودة لاحقًا — القائمة تتجدد باستمرار.',
