...
export const ROLE_OPTIONS: ReadonlyArray<RoleOption> = [
  { role: 'customer', titleAr: 'عميل', descriptionAr: 'اطلب صيانة لأجهزتك وتابع طلباتك', icon: '🏠' },
  { role: 'technician', titleAr: 'فني', descriptionAr: 'استقبل طلبات الصيانة وأدر خدماتك', icon: '🛠️' },
  { role: 'merchant', titleAr: 'تاجر', descriptionAr: 'اعرض منتجاتك وأدر وجودك التجاري', icon: '🏬' },
];
